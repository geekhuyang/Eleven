...
- (void)viewDidLoad
{
    ...
    mainTableView.tableHeaderView=titleLabel;
    [self addHeader];
...
- (void)addHeader{
    ...
    __weak typeof(mainTableView) weakTableView = mainTableView;
    __weak typeof(refreshHeader) weakRefreshHeader = refreshHeader;

    refreshHeader.beginRefreshingBlock=^(){
        __strong typeof(mainTableView) strongTableView = weakTableView;
        __strong typeof(refreshHeader) strongRefreshHeader = weakRefreshHeader;
